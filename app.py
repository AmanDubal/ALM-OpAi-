...
def main():
    st.title("🎵 ALM - Audio Language Model")
    st.write("🧠 Powered by OpenRouter AI — Understand Audio with AI Intelligence")
    st.divider()
        ...
        if audio_file is not None:
            ...
            try:
                ...
                with progress_ph.container():
                    st.write("📥 Step 1/6: Loading & Preprocessing Audio")
                ...
                with results_ph.container():
                    ...
                    cols = st.columns(3)
                    cols[0].metric("⏱️ Duration", f"{audio_duration:.2f}s")
                    cols[1].metric("🔊 Sample Rate", f"{audio_info['sample_rate']} Hz")
                    cols[2].metric("📈 Peak Amplitude", f"{audio_info['peak_amplitude']:.3f}")

                # ── Step 2: Speech Recognition ───────────────────────────────
                with progress_ph.container():
                    st.write("🗣️ Step 2/6: Performing Speech Recognition")
                ...
                if ENABLE_EMOTION_ANALYSIS:
                    with progress_ph.container():
                        st.write("😊 Step 4/6: Analyzing Emotional Tone")
                    ...
                    with results_ph.container():
                        ...
                        cols = st.columns(2)
                        cols[0].metric("😊 Emotion", emotion_detected.upper())
                        cols[1].metric("🎯 Confidence", f"{emotion_confidence:.1%}")

                # ── Step 5: Context Integration ──────────────────────────────
                with progress_ph.container():
                    st.write("🔗 Step 5/6: Integrating Audio Context")
                ...
                with results_ph.container():
                    st.success("✅ Context Integration Complete")
                    st.markdown("""
                        <div class="animated-container" style="margin-top:15px;">
                            <p style="color:#00d4ff;font-weight:bold;text-transform:uppercase;
                ...
                if ENABLE_REASONING:
                    with progress_ph.container():
                        st.write("🧠 Step 6/6: Generating AI Inference via OpenRouter")
                    ...
                    with results_ph.container():
                        st.success("✅ OpenRouter AI Reasoning Complete")
                        st.markdown("""
                            <div class="animated-container" style="margin-top:15px;
